...
class QL {
	...
	private $collect_draft_translations_gettext;
	private $collect_draft_translations_ngettext;
	private $collect_draft_translations_gettext_with_context;
	private $collect_draft_translations_ngettext_with_context;
	...
	private function check () {
		...
		if ( ! isset ( $ql_options [ "warn_on_duplicates" ] ) ) {
			$ql_options [ "warn_on_duplicates" ] = "yes";
			$saveaftercheck = true;
		}
		if ( ! isset ( $ql_options [ "default_order_by" ] ) ) {
			$ql_options [ "default_order_by" ] = "id";
			$saveaftercheck = true;
		}
		if ( ! isset ( $ql_options [ "collect_draft_translations_fe" ] ) ) {
			$ql_options [ "collect_draft_translations_fe" ] = "no";
			$saveaftercheck = true;
		}
		if ( ! isset ( $ql_options [ "collect_draft_translations_be" ] ) ) {
			$ql_options [ "collect_draft_translations_be" ] = "no";
			$saveaftercheck = true;
		}
		if ( ! isset ( $ql_options [ "collect_draft_translations_gettext" ] ) || "yes" != $ql_options [ "collect_draft_translations_gettext" ] ) {
			$ql_options [ "collect_draft_translations_gettext" ] = "yes";
			$saveaftercheck = true;
		}
		if ( ! isset ( $ql_options [ "collect_draft_translations_ngettext" ] ) ) {
			$ql_options [ "collect_draft_translations_ngettext" ] = "no";
			$saveaftercheck = true;
		}
		if ( ! isset ( $ql_options [ "collect_draft_translations_gettext_with_context" ] ) ) {
			$ql_options [ "collect_draft_translations_gettext_with_context" ] = "no";
			$saveaftercheck = true;
		}
		if ( ! isset ( $ql_options [ "collect_draft_translations_ngettext_with_context" ] ) ) {
			$ql_options [ "collect_draft_translations_ngettext_with_context" ] = "yes" == $ql_options [ "collect_draft_translations_ngettext" ] && "yes" == $ql_options [ "collect_draft_translations_gettext_with_context" ] ? "yes" : "no";
			$saveaftercheck = true;
		}
		if ( ! isset ( $ql_options [ "only_unknown" ] ) ) {
			$ql_options [ "only_unknown" ] = "no";
			$saveaftercheck = true;
		}
		if ( ! isset ( $ql_options [ "footer_textarea" ] ) ) {
			$ql_options [ "footer_textarea" ] = "no";
			$saveaftercheck = true;
		}
		if ( ! isset ( $ql_options [ "only_superadmins" ] ) ) {
			$ql_options [ "only_superadmins" ] = "no";
			$saveaftercheck = true;
		}
		...
		$this -> collect_draft_translations_gettext = "yes" == $ql_options [ "collect_draft_translations_gettext" ];
		$this -> collect_draft_translations_ngettext = "yes" == $ql_options [ "collect_draft_translations_ngettext" ];
		$this -> collect_draft_translations_gettext_with_context = "yes" == $ql_options [ "collect_draft_translations_gettext_with_context" ];
		$this -> collect_draft_translations_ngettext_with_context = "yes" == $ql_options [ "collect_draft_translations_ngettext_with_context" ];
